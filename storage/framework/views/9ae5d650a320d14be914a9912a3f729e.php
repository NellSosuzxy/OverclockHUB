...
<?php $__env->startSection('content'); ?>
    ...
    <div id="missing-info-modal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 9999; display: flex; align-items: center; justify-content: center; animation: fadeIn 0.3s ease-out;">
        <div style="background: var(--bg-card); border: 2px solid var(--danger); padding: 2.5rem; max-width: 500px; text-align: center; box-shadow: 0 0 30px rgba(255,51,51,0.2);">
            ...
            <p style="color: var(--text-main); margin-bottom: 2rem;"><?php echo e(session('error')); ?></p>
    ...
    <div class="grid-2">
        <div style="background-color: var(--bg-card); border: 1px solid var(--border); padding: 2.5rem;">
            ...
            <form method="POST" action="<?php echo e(route('profile.update')); ?>">
                ...
                <input type="email" class="form-control" value="<?php echo e($user->email); ?>" disabled style="opacity: 0.5;">
                ...
                <input type="text" name="phone" id="phone-field" class="form-control" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="+60 12-XXX XXXX">
                ...
                <textarea name="address" id="address-field" class="form-control" rows="3" placeholder="Full shipping address..." style="transition: box-shadow 0.3s ease;"><?php echo e(old('address', $user->address)); ?></textarea>

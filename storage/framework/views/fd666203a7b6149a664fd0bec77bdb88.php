    ...
    <div style="max-width: 700px; margin: 4rem auto; text-align: center;">
        ...
        <div style="background-color: rgba(0, 255, 102, 0.05); border: 1px solid var(--success); padding: 1.5rem; margin-bottom: 2rem; text-align: left; position: relative; overflow: hidden;">
            ...
            <p style="color: var(--text-main); font-family: monospace; font-size: 0.95rem; margin-bottom: 0; line-height: 1.6;">
                Your transaction of <strong style="color: var(--accent);">RM <?php echo e(number_format($order->total, 2)); ?></strong> was successful. The components have been officially logged and are currently queuing for logistics deployment.
            </p>
        </div>
        ...
        <div style="background-color: var(--bg-card); border: 1px solid var(--border); padding: 2.5rem; text-align: left;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                ...
                <span style="font-family: monospace; color: var(--accent);"><?php echo e($order->trace_id); ?></span>
            </div>
            <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
            ...
            <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                ...
                <span style="font-family: monospace;">RM <?php echo e(number_format($order->subtotal, 2)); ?></span>
            </div>
            <?php if($order->discount > 0): ?>
                <div style="display: flex; justify-content: space-between; margin-bottom: 1rem; color: var(--success);">
                    <span>Discount</span>
                    <span style="font-family: monospace;">-RM <?php echo e(number_format($order->discount, 2)); ?></span>
                </div>
            <?php endif; ?>
            <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                <span style="color: var(--text-muted);">Shipping</span>
                <span style="font-family: monospace;"><?php echo e($order->shipping_fee == 0 ? 'FREE' : 'RM ' . number_format($order->shipping_fee, 2)); ?></span>
            </div>
            <div style="display: flex; justify-content: space-between; padding-top: 1rem; border-top: 1px dashed var(--border);">
                ...
                <span style="font-family: monospace; font-size: 1.4rem; color: var(--accent);">RM <?php echo e(number_format($order->total, 2)); ?></span>
            </div>
        </div>

        <div style="margin-top: 2rem; display: flex; gap: 1rem; justify-content: center;">
            <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-outline">View All Orders</a>
            <a href="<?php echo e(route('home')); ?>" class="btn btn-primary">Continue Shopping</a>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/order-success.blade.php ENDPATH**/ ?>
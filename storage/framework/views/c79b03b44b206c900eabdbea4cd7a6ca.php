...
<body>
    ...
    <nav>
        <a class="logo" href="<?php echo e(route('home')); ?>">OVERCLOCK<span>HUB</span></a>
        <div class="nav-links">
            <a href="<?php echo e(route('home')); ?>">Terminal</a>
            <a href="<?php echo e(route('about')); ?>">About</a>              <a href="<?php echo e(route('gallery')); ?>">Gallery</a>            <div class="dropdown">
                <a>Hardware</a>
                <div class="dropdown-content">
                    <div class="cat-group">
                        <h4>Core</h4>
                        <a href="<?php echo e(route('catalog', 'cpu')); ?>">Processors (CPU)</a>
                        <a href="<?php echo e(route('catalog', 'gpu')); ?>">Graphics (GPU)</a>
                        <a href="<?php echo e(route('catalog', 'mobo')); ?>">Motherboards</a>
                        <a href="<?php echo e(route('catalog', 'ram')); ?>">Memory (RAM)</a>
                    </div>
                    <div class="cat-group">
                        <h4>Storage</h4>
                        <a href="<?php echo e(route('catalog', 'ssd')); ?>">NVMe SSD</a>
                        <a href="<?php echo e(route('catalog', 'hdd')); ?>">Enterprise HDD</a>
                    </div>
                    <div class="cat-group">
                        <h4>Power &amp; Cooling</h4>
                        <a href="<?php echo e(route('catalog', 'psu')); ?>">Power Supplies</a>
                        <a href="<?php echo e(route('catalog', 'cooler')); ?>">CPU Coolers</a>
                        <a href="<?php echo e(route('catalog', 'fans')); ?>">Case Fans</a>
                    </div>
                    <div class="cat-group">
                        <h4>Build &amp; Gear</h4>
                        <a href="<?php echo e(route('catalog', 'case')); ?>">PC Cases</a>
                        <a href="<?php echo e(route('catalog', 'monitor')); ?>">Monitors</a>
                        <a href="<?php echo e(route('catalog', 'keyboard')); ?>">Keyboards</a>
                        <a href="<?php echo e(route('catalog', 'mouse')); ?>">Mice</a>
                        <a href="<?php echo e(route('catalog', 'audio')); ?>">Headsets</a>
                    </div>
                </div>
            </div>
            <a href="<?php echo e(route('contact')); ?>">Support</a>
            <a href="<?php echo e(route('policies')); ?>">Policies</a>
            ...
            <div style="display: flex; gap: 2rem; align-items: center; border-left: 1px solid var(--border); padding-left: 2rem; margin-left: 1rem;">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" style="color: var(--danger); font-family: monospace; font-weight: 700;">[ ROOT_ACCESS_GRANTED ]</a>
                        <form action="<?php echo e(route('logout')); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-danger">Terminate</button>
                        </form>
                    <?php else: ?>
                        <a href="<?php echo e(route('profile.edit')); ?>" style="border-right: 1px solid var(--border); padding-right: 1.5rem; color: var(--accent);"><span style="font-family: monospace;">[ OPERATOR: <?php echo e(strtoupper(Auth::user()->name)); ?> ]</span></a>
                        <a href="<?php echo e(route('cart.index')); ?>" style="color: var(--text-main); font-weight: 700; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px;">Queue (<?php echo e($cartCount); ?>)</a>
                        <a href="<?php echo e(route('orders.index')); ?>" style="color: var(--text-main); font-weight: 700; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px;">Telemetry</a>
                        <form action="<?php echo e(route('logout')); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline">Initialize Login</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>

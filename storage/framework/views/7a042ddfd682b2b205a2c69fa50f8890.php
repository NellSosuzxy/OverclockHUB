...
<div class="hero" style="background: var(--bg-main); overflow: hidden;">
    ...
    <video autoplay loop muted playsinline class="hero-video">
        <source src="<?php echo e(asset('videos/About us.mp4')); ?>" type="video/mp4">
    </video>
...
<div style="max-width: 800px; margin: 0 auto 4rem;">
    <div class="feature-box stagger-item">
        ...
        <div style="margin-top: 2rem; display: flex; gap: 1.5rem;">
            <a href="<?php echo e(route('catalog', 'cpu')); ?>" class="btn btn-primary">Browse Hardware <i data-lucide="chevron-right" style="width: 1.2rem; height: 1.2rem; margin-left: 0.5rem;"></i></a>
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline">Contact Support</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/about.blade.php ENDPATH**/ ?>
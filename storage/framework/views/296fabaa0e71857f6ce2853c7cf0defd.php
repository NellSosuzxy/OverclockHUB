...
<div class="grid-2">
    <div>
        <div style="background-color: var(--bg-card); border: 1px solid var(--border); padding: 2.5rem; margin-bottom: 2rem;">
            ...
            <form method="POST" action="<?php echo e(route('contact.store')); ?>" onsubmit="this.querySelector('button').disabled = true; this.querySelector('button').innerHTML = 'TRANSMITTING...';">
                <?php echo csrf_field(); ?>
                ...
                <input type="text" name="name" class="form-control" placeholder="Enter callsign..." value="<?php echo e(old('name', Auth::user()->name ?? '')); ?>" required>
                ...
                <input type="email" name="email" class="form-control" placeholder="secure@channel.com" value="<?php echo e(old('email', Auth::user()->email ?? '')); ?>" required>
                ...
                <input type="text" name="reference_id" class="form-control" placeholder="#ORD-XXXX" value="<?php echo e(old('reference_id')); ?>">
                ...
                <textarea name="message" class="form-control" rows="5" placeholder="Describe the issue in detail..." required><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/contact.blade.php ENDPATH**/ ?>
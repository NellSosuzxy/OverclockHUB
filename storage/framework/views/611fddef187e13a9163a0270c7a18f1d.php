    ...
    <div style="max-width: 500px; margin: 4rem auto;">
        <div style="background-color: var(--bg-card); border: 1px solid var(--danger); padding: 3rem;">
            ...
            <form method="POST" action="<?php echo e(route('admin.authenticate')); ?>">
                ...
                <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" required autofocus placeholder="root@overclockhub.com">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/login.blade.php ENDPATH**/ ?>
...
<div class="gallery-grid">
    ...
    <div class="gallery-item stagger-item">
        ...
        <video autoplay loop muted playsinline class="gallery-media">
            <source src="{{ asset('videos/Left.mp4') }}" type="video/mp4">
        </video>
    ...
    <!-- Image Item 1 -->
    <div class="gallery-item stagger-item">
        <img src="{{ asset('images/PC close up 1.avif') }}" loading="lazy" alt="PC Close up" class="gallery-media">
        <div class="gallery-info">
    ...
    <div class="gallery-item stagger-item">
        ...
        <video autoplay loop muted playsinline class="gallery-media">
           <source src="{{ asset('videos/RGB sync.mp4') }}" type="video/mp4">
        </video>
        <div class="gallery-info">
    ...
    <!-- Image Item 2 -->
    <div class="gallery-item stagger-item">
        <img src="{{ asset('images/PC close up 2.avif') }}" loading="lazy" alt="PC Components" class="gallery-media">
        <div class="gallery-info">
    ...
    <!-- Image Item 3 -->
    <div class="gallery-item stagger-item">
        <img src="{{ asset('images/Custom keyboard.jpg') }}" loading="lazy" alt="Custom Keyboard" class="gallery-media">
        <div class="gallery-info">
    ...
    <!-- Image Item 4 -->
    <div class="gallery-item stagger-item">
        <img src="{{ asset('images/Custom cooling.jpg') }}" loading="lazy" alt="Custom Cooling" class="gallery-media">
        <div class="gallery-info">

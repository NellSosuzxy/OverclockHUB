    ...
    <div style="max-width: 500px; margin: 4rem auto;">
        <div style="background-color: var(--bg-card); border: 1px solid var(--border); padding: 3rem;">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name') }}" required autofocus placeholder="Enter callsign...">
                ...
                <input type="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="operator@overclockhub.com">
            ...
            <p style="text-align: center; margin-top: 1.5rem;">
                ...
                <a href="{{ route('login') }}" style="color: var(--accent); font-size: 0.85rem; font-weight: 700;">Login Here</a>
            </p>
        </div>
    </div>
@endsection

    ...
    <div style="max-width: 600px;">
        <div style="background-color: var(--bg-card); border: 1px solid var(--border); padding: 2.5rem;">
            <form method="POST" action="{{ route('admin.products.store') }}">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. AMD Ryzen 9 9950X">
                ...
                <input type="number" name="price" class="form-control" step="0.01" min="0" value="{{ old('price') }}" required placeholder="0.00">
                ...
                <input type="text" name="image_label" class="form-control" value="{{ old('image_label') }}" placeholder="e.g. CPU, GPU, RAM (auto-generated if empty)">
                ...
                <input type="number" name="stock" class="form-control" min="0" value="{{ old('stock', 50) }}" required>
